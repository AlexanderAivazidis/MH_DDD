...
#         pickle_out.close()
        ...
        pickle_out = open("data/celltypeClassification/CortexOnly_" + cortexData['SlideName'][0] + 'Section' + cortexData['Section'][0] + "Classification-" + celltypeOrder[channel] + '.pickle',"wb")
