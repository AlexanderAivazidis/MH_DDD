...
for slide in chunks[int(chunkID)]:            
    ...
    # Run Gaussian Mixture model to find oligondendrocytes and remove bleedthrough from Plp1 flurophore
    ...
    for section in np.unique(uniqueSectionNumbers):
        ...
        for channel in range(5):
            ...
            with pm.Model() as model:
                ...
                sigmas = pm.Gamma('sigma', mu = np.array((0.33,1)), sigma = np.array((0.33,1)), shape = 2)
